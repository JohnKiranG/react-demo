  ...
  render() {
    ...
    return (
      <Form>
        ...
        </FormItem>) : (<FormItem {...formItemLayout} label="Organization Type" type>
          {getFieldDecorator('client.clientType', {
            rules: [{ required: true, message: 'Please select Organization Type' }],
            initialValue: 'SITE',
          })(
            <Select mode="single" placeholder="Please Select" disabled>
              <Option value="CRO">CRO</Option>
              <Option value="SITENETWORK">Site Network</Option>
              <Option value="SITE">Site</Option>
              <Option value="SPONSOR">Sponsor</Option>
        ...
        <FormItem {...formItemLayout} label="Organization OID">
